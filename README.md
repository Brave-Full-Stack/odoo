...
This branch contains a tested local Odoo 19.0 installation optimized for development VMs and manual deployments, running directly without Docker containers.
...
### 1. Clone This Branch
```bash
git clone git@github.com:Brave-Full-Stack/odoo.git -b Odoo-19.0-local-dev
cd odoo
```
...
git pull origin Odoo-19.0-local-dev
./start-odoo.sh my_dev_db
...
git push origin Odoo-19.0-local-dev
```
...
|--------|---------|----------|
| **19.0** | Official Odoo | Base/reference (tracks upstream) |
| **Odoo-19.0-local-dev** | Manual install | **This branch** - Local VM development |
| **Odoo-19.0-containerized** | Docker setup | Testing, staging (port 8070) |
| **Odoo-19.0-microservices** | K8s/CI/CD | Production, cloud, Kubernetes manifests |
